<template>
  <div class="main">
    ...
    <van-tree-select class="tree" ref="treeSelect" height="auto"
      :style="{ '--beforeHeight': beforeHeight, '--afterHeight': afterHeight }" :items="items"
      :active-id.sync="items.activeId" :main-active-index.sync="items.activeId" @click-nav="onNavClick" v-else>
      <template slot="content">
        <div v-if="tableSelect.length > 0">
          <div class="m_box" v-for="item in tableSelect" :key="item.index"
